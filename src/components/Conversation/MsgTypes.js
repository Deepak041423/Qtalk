...
const DocMsg = ({el,menu}) => {
  ...
  return (
    ...
    <Box  p={1.5} sx={{backgroundColor : el.incoming 
            ...
            <Stack spacing={2}>
              <Stack p={2} spacing={3} direction={'row'} alignItems={'center'} sx={{backgroundColor:theme.palette.text , borderRadius:1}}>
              <Image size={48}/>
              ...
              <Typography  sx={{color: el.incoming ? theme.palette.text : "#fff"}} variant='body2'>
                {el.message}
              </Typography>
            ...
            <Box  p={1.5} sx={{backgroundColor : el.incoming 
                ...
                width:'max-content'
                    ...
                    <Stack spacing={1}>
                        ...
                        <Typography variant='body' color={el.incoming ? theme.palette.text : "white"}>
                            {el.message}
                        </Typography>
                    </Stack>
