    ...
    <Box sx={{width:320 , height:'100vh'}}>
      <Stack sx={{height: '100%'}}>
        ...
        <Box sx={{
          ...
          <Stack justifyContent='space-between' alignItems='center' sx={{height:'100%' , p: 2}} direction='row' spacing={3}>
        ...
        <Stack sx={{height:'100%' , position:'relative' , flexGrow: 1 ,overflowY: 'scroll'}} p={3} spacing={3}>
              ...
              <Stack spacing={0.5}>
                  ...
                  <Typography variant='body2'>You gave me Purpose</Typography>
              </Stack>
              ...
              <Divider/>
                  ...
                  <Stack direction={'row'} spacing={2} alignItems={'center'}>
                    ...
                    <Stack spacing={0.5}>
                      <Typography variant='subtitle2'>Java Batch</Typography>
