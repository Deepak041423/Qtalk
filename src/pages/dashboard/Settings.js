...
<>
    <Stack direction={'row'} sx={{width:'100%'}}>
        {/* Left Panel */}
        <Box sx={{overflowY: "scroll",height:'100vh',width:320,backgroundColor: theme.palette.mode === 'light' ? '#F8FAFF' : theme.palette.background, boxShadow:'0px 0px 0px rgba(0,0,0,0.25)'}}>
            <Stack p={4} spacing={5}>
                {/* Header */}
