...
const ResetPassword = () => {
  return (
    ...
    <Stack spacing={2} sx={{mb:5, position:'relative'}}>
        ...
        <Typography sx={{color: "text.secondary", mb:5}}>Please enter the email address associated with your account and we will email you a link to <b> reset your password</b></Typography>
